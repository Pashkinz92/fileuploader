...
class UploaderController extends Controller {
    ...
    function actionDelete()
    {
        ...
        else
        {
            ...
            $image = Yii::$app->db->createCommand($sql)->bindParam(':id', $id)->bindValue(':id_user', Yii::$app->session->getHasSessionId())->queryRow();
            if(!$image)
            {
                return false;
            }
            ...
            if( $image['is_main']==1 )
            {
                ...
                $main_image = Yii::$app->db->createCommand($sql)->bindValue(':id_user', Yii::$app->session->getHasSessionId())->queryRow();
            }
...

        {
            ...
            if( $f_size>MAX_SIZE )
            {
                ...
                else
                {
                    ...
                    $info['ok'] = true;
                    $info['url'] = $img_dir_upload['preview']['200'].$filenameNew;
