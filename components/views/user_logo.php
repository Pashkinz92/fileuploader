        ...
        <div class="modalbody b-r-all-5">
            ...
            <div class="load_logo b-r-top-5">
                <form action="." id='user-logo-form' method='POST' enctype='multipart/form-data' autocomplete='off'>
                    ...
                    <div id="<?= $this->context->params['type'];?>-upload-area" class="upload-area b-r-all-5">
                        ...
                        <div class="modalfooter clr-a b-r-bottom-5">
                            <div class="file-explorer fll btn small def_btn2 b-r-all-3 fll" title="">
                                ...
                                <input type="file" name="<?= $this->context->params['fileKey'];?>" accept="image/*" >
                            </div>
...
<script id="<?= $this->context->params['type'];?>-upload" type="text/x-tmpl">
...
<script id="<?= $this->context->params['type'];?>-download" type="text/x-tmpl">
{% for (var i=0, file; file=o.files[i]; i++) { %}
    {% if(file.no_image) { %}
